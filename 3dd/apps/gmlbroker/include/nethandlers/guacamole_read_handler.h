...
class GuacamoleReadHandler {
    public:
        std::thread Run(NetQueue &queue, NetQueue &recv_queue, GuacamoleServer &guacamole_server, ChannelTable &table, ApprovalRegistry &approvals, ReaderGroup &readers, uint16_t channel, int fd);
};
